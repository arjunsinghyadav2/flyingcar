...
class MotionPlanning(Drone):
    ...
    def plan_path(self,gl):
        ...
        desired = global_to_local([goal[0],goal[1],10.0],self.global_home)
        grid_goal = ( -north_offset+int(gtl[0]) + desired[0], -east_offset+int(gtl[1])+ desired[1])
