...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal_lon', type=str, help="goal lon")
    parser.add_argument('--goal_lat', type=str, help="goal lat")
    parser.add_argument('--goal_alt', type=str, help="goal alt")
